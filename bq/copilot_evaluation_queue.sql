...
WITH queued AS (
  SELECT
    ...
    p.intro_offer_count_current_membership,
    p.intro_offer_subtotal_usd_current_membership AS intro_offer_usd_current_membership,
    p.intro_offer_subtotal_cad_current_membership AS intro_offer_cad_current_membership,
